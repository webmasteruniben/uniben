    ...
    <div class="page">
        <header>
            ...
            <div id="secondary-menu">
                <div style="text-align: right;padding-top: 18px;">
                    ...
                    <a href="contact/contactus.php" target="_blank" class="secondary-menu-link link-border">Contact Us</a>
                </div>
        ...
        <div class="page_head">
                ...
                <form action="contactus.php" method="post">
                    ...
                    <aside style="margin-bottom: 20px;">
                        ...
                        <div class="academic_calendar" style="background-color: #C6C1C5;">
                            ...
                            <div class="map">
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d63442.93369776195!2d5.579885213616445!3d6.370312722606933!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x1040d3014e1c75cf%3A0x5f3cd0b086c0e598!2sUniversity%20of%20Benin!5e0!3m2!1sen!2sng!4v1599746459466!5m2!1sen!2sng" width="650" height="490" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
            </div>           
            ...
            <ul class=" col-lg-offset-1 col-4 address" > 
					<li class="item"><i class="fa fa-user-circle" aria-hidden="true"></i> <a href="login.php" target="#" style="color: blue; text-decoration: none;">Admin.</a></li>
  </ul>
